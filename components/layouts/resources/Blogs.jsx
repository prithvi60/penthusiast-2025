            ...
            <div className="grid grid-cols-1 md:grid-cols-2 place-content-center place-items-center xl:grid-cols-3 gap-8">
                {posts.map((item, idx) => (
                    <Link
                        ...
                        key={idx}
                        className="rounded-lg shadow-lg border border-[#AFACAC] overflow-hidden hover:scale-110 duration-300 ease-in-out transition-all cursor-pointer max-w-96"
                    >
...
const blogs = [
    {
        img: "/blog.png",
        alt: "blog bg image",
        note: "Game changing advantages of hiring a fractional content team",
